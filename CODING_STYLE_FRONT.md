# Guia de estilo e padrões de código - Frontend (Mobile)
...
Adoção do padrão "Conventional Commits" para um histórico claro e legível. //o proprio vscode/git tem uma extensao que destaca esses padrões, link de insstalação: (https://github.com/iuricode/padroes-de-commits)
